...
@interface TargetRectangleModelDetect : UIView

@property (assign,readwrite) CGRect roi; // width/height

@property (assign,readwrite) CGRect redLineRoi;
...
@property (readwrite) float red_line_width;
...
@property(nonatomic) CGRect tendorFlowDetectedRect;

@property(nonatomic) BOOL isDisableDrawingRect;

@property(nonatomic) NSString *debugDataString;
